              ...
              <div class="field">
                <div class="control">
                  ...
                  <div v-if="$v.form.avatar.$error" class="form-error">
                    ...
                    <span v-if="!$v.form.avatar.allowedFilesExtensions" class="help is-danger">Selected file type is not valid!</span>
                  </div>
                </div>
              </div>
              <div class="field">
...
import { allowedFilesExtensions } from '@/helpers/validators'
